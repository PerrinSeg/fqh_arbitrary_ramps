...
Namespace SpectronServiceReference
    ...
    Public Interface ISpectron
        ...
        Sub AddTunnelGaugeRamp2(ByVal conversion_coeffs() As Double, ByVal start_tunneling As Double, ByVal stop_tunneling As Double, ByVal t_start As Double, ByVal t_stop As Double, ByVal voltage_offset As Double, ByVal calib_volt As Double, ByVal calib_depth As Double, ByVal dat_chan As Integer)
    ...
    Partial Public Class SpectronClient
        ...
        Public Sub AddTunnelGaugeRamp2(ByVal conversion_coeffs() As Double, ByVal start_tunneling As Double, ByVal stop_tunneling As Double, ByVal t_start As Double, ByVal t_stop As Double, ByVal voltage_offset As Double, ByVal calib_volt As Double, ByVal calib_depth As Double, ByVal dat_chan As Integer) Implements SpectronServiceReference.ISpectron.AddTunnelGaugeRamp2
            MyBase.Channel.AddTunnelGaugeRamp2(conversion_coeffs, start_tunneling, stop_tunneling, t_start, t_stop, voltage_offset, calib_volt, calib_depth, dat_chan)
        End Sub
