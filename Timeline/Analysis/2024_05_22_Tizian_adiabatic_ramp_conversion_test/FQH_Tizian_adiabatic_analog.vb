...
'(3) pinning
Dim pinning_dur As Double = 1000
...
' quad
analogdata.AddRamp(twodphysics_start_time, quad_init, quad_turnon_start_time, quad_turnon_end_time, ps8_ao) 'ps8_ao
...
'2D2
analogdata.AddInterpolatedRampUsingFile(quicTunnelRampPath, lattice2_init_v, lattice2_final_v, ramp_start_time, ramp_end_time, ps7_ao) 'lattice2D765_power2
...
'quad
analogdata.AddInterpolatedRampUsingFile(quadTiltRampPath, quad_init, quad_final, ramp_start_time, ramp_end_time, ps3_ao) 'ps8_ao
...
' 2D1 
analogdata.AddSmoothRamp(lattice1_final_v, lattice1_max_volt, ramp_end_time, pinning_end_time, lattice2D765_power)
' 2D2 raise to final depth and hold
analogdata.AddSmoothRamp(lattice2_final_v, lattice2_max_volt, ramp_end_time, pinning_end_time, lattice2D765_power2)
