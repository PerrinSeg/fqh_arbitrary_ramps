...
name_sequence = 'fqh_adiabatic_ramp_old_tracking.vb';
...
ii = find(contains(keys_containers, 'addtrackingsequence2'),1)
sub_variable_list = sub_variable_containers(keys_containers{ii});
i = findIndex(sub_variable_list, 'last_time');
last_time_tracking = eval(sub_variable_list{i}{2}); % in ms
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
channel_list = {'lattice2d765_power', 'lattice2d765_power2', 'line_dmd_power', 'hor_dmd_power', ...
    'apogee_camera', 'line_dmd_ttl', 'hor_dmd_ttl', 'lattice2d765_ttl', 'lattice2d765_ttl2', 'lattice2d765_shutter', 'ixon_flip_mount_ttl'};
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
if plot_figure
    ...
    for k = 1:N_chan
        ...
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        xline(twodphysics_start_time/1000, '--g', 'Linewidth', 1.25,'DisplayName', '2d_physics_start')
        ...
        xline(pinning_start_time/1000, '--r', 'Linewidth', 1.5, 'DisplayName', 'pinning_start')
        xline(pinning_end_time/1000, '--r', 'Linewidth', 1.5, 'DisplayName', 'pinning_end')
        xline(last_time/1000, '-', 'Linewidth', 1.5, 'DisplayName', 'last')
        xline(last_time_tracking/1000, '--c', 'Linewidth', 1, 'DisplayName', 'last_time_tracking')
