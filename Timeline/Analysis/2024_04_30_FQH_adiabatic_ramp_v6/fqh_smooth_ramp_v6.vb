...
Dim quicRampPath As String = "Z:\\experiments\\FQH\\rampfiles\\quicRamp_4x1N2_tiltY135_Vy5p5Er.txt"
...
Dim anticonfine_volt As Double = 2.5 '2.4
...
Dim loadline_DMD_volt_horz As Double = 3.15
...
Dim Berlin_wall_kick_volt As Double = 2.9 '2.8
...
Dim quad_raise_start_time As Double = hold_end_time
...
If (quad_grad_init > 0) Then
    ...
    'lower quad
    'analogdata2.AddInterpolatedRampUsingFile(freqVoltRampPath, quad_grad_init * ps8_scaler, quad_grad_final * ps8_scaler, quad_lower_start_time, quad_lower_end_time, ps8_ao)
    ...
    analogdata2.AddStep(quad_grad_final * ps8_scaler, quad_lower_end_time, quad_raise_start_time, ps8_ao)
    If (is_return > 0) Then
        'raise quad
        'analogdata2.AddInterpolatedRampUsingFile(freqVoltRampPath, quad_grad_final * ps8_scaler, quad_grad_init * ps8_scaler, quad_raise_start_time, quad_raise_end_time, ps8_ao)
    ...
    Else
        analogdata2.AddStep(quad_grad_final * ps8_scaler, quad_raise_start_time, grad_turnoff_start_time, ps8_ao)
        'turn off 
...
If (use_gauge > 0) Then
	...
	analogdata2.AddStep(gauge_power, raman_rampup_end_time, raman_rampdown_start_time, gauge1_power)
