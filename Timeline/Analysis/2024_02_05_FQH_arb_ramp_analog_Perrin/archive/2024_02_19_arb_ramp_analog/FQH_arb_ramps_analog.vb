...
Dim lattice1_ramp_v_return As Double()
Dim lattice2_ramp_j_return As Double()
Dim gauge_power_ramp_j_return As Double()
Dim gauge_freq_ramp_v_return As Double()  
Dim quad_ramp_v_return As Double()
Dim quic_ramp_v_return As Double()
...
'Dim gauge_power_start_v As Double = GaugeJToVolts(gauge_power_ramp_j(0), gauge_JtoVolt_coeffs)
'Dim gauge_power_ramp_end_v As Double = GaugeJToVolts(gauge_power_ramp_end_j, gauge_JtoVolt_coeffs)
